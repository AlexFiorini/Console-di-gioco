...
public class PlayerData {
    ...
    public void addShip(Coordinate a,Coordinate b,Coordinate c){
        ...
        if(isEdge(a, b, c)){
            System.out.print("\nPrevenendo l'aggiunta di una nave: la flotta è piena o l'utente ha fatto clic troppo vicino al bordo");
        }
        else {
            if (isOvelap(a, b, c) ) {
                if(isOvelapAtRotatePoint(a,b,c) && !isShipCollision(a,b,c)){
                    ...
                    System.out.print("\nDovresti fare clic solo sul primo blocco per ruotare");
                }
    ...
    public void setAttackData(int x, int y, String result) {
        ...
        else if(result.equals("Fallimento")){
            attackData[x][y] = 2;
        }
    }
