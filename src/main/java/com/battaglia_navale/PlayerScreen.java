...
public class PlayerScreen extends JFrame {
    ...
    public PlayerScreen(String name, boolean show,BattleShip battleShip) {
        ...
        JButton next = new JButton("Prossimo turno");

        Box verticalBox = Box.createVerticalBox();

        Box horizontalBox0 = Box.createHorizontalBox();
        horizontalBox0.add(new JLabel("Stato del: "+name));
        verticalBox.add(horizontalBox0, BorderLayout.WEST);

        Box horizontalBox1 = Box.createHorizontalBox();
        horizontalBox1.add(new JLabel("Navi proprie: "));
        ...
        horizontalBox2.add(new JLabel("Navi proprie affondate: "));
        ...
        horizontalBox3.add(new JLabel("Navi nemiche affondate: "));
